<template>
  <v-card class="mt-4 mx-1 rounded-0">
    <v-card-text class="cardNew py-1 black white--text rounded-0"
      >New</v-card-text
    >
    <v-card-text class="cardDiscount py-1 grey darken-1 white--text" v-if="status=='Product Discount'"
      >-20%</v-card-text
    >
    <v-img
      src="https://www.fabindia.com/ccstore/v1/images/?source=/file/v6387149487885218198/products/10628633SF.f.211219.jpg&height=475&width=475"
      height="320px"
    ></v-img>

    <v-card-title> Furniture Name </v-card-title>
    <v-card-subtitle class="pb-0"> InStock </v-card-subtitle>
