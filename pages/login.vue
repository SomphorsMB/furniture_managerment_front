    ...
    <v-row>
      <v-col cols="6" xl="6" lg="6" md="6" sm="12" xs="12" class="pa-0">
        <v-img
          ...
          elevation="2"
          height="80vh"
          src="https://images.squarespace-cdn.com/content/v1/5a85f1ae010027c3e21cfb7e/1598488914272-U54L2WW06JI3SLNFPTMN/OS_room4_rev2+%281%29.jpg"
        >
          <v-card
            class="
              cards
          ...
          >
            ...
            <v-card-text class="black--text text-h3 py-0 font-weight-black"
              >Furniture</v-card-text
            >
            <v-card-text class="grey--text text-h4 py-0">Modern</v-card-text>
            <v-card-text class="black--text text-h6 px-2 pb-0"
              >Login to the
              <strong class="font-weight-black">manage</strong> the product and
              deliver modern furniture to the
            </v-card-text>
            <v-card-text class="black--text text-h5 py-0 font-weight-black"
              >World Wide Customers</v-card-text
            >
          </v-card>
        </v-img>
      </v-col>
      <v-col cols="6" xl="6" lg="6" md="6" sm="12" xs="12" class="pa-0">
        <v-card
          flat
          height="80vh"
          class="right-card d-flex align-center rounded-0"
        >
          <v-form class="justify-center px-12">
            <v-row>
              ...
              <v-btn
                to="/"
                class="mx-auto font-weight-black white--text grey"
                width="40%"
                >Login</v-btn
              >
            </v-row>
